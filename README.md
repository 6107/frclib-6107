...
|     <input type="checkbox">     |        -       |                                                                                                                                                                                   |
|     <input type="checkbox">     |   performance  | Review existing code so far and address and areas for increasing code efficiency, or create items for the improvement                                                             |
|     <input type="checkbox">     |        -       |                                                                                                                                                                                   |
|     <input type="checkbox">     | fault handling | Review existing code so far and address and areas for increasing code stability and recovery, or create items for the improvement                                                 |
|     <input type="checkbox">     |        -       |                                                                                                                                                                                   |
